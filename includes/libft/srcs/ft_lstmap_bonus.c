...
/*   Updated: 2025/05/26 19:24:51 by pab              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
1]	le pointeur 'tmp_content' prend (la resultante de (*f)) et
	(du contenu de lst) 'tmp' pointe vers le nouveau noeud cree avec le contenu
	de 'lst' via ft_lstnew
...
3]	Lier le nouveau noeud (tmp) a la la nouvelle liste chainee (newlst)
	Next noeud -> le pointeur 'lst' devient le pointeur du contenur du noeud
	suivant
